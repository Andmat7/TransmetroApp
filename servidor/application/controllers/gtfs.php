<?php
class Gtfs extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        $this->load->model('gtfs_model');
    }
    
    function index()
    {
        $this->load->view('gtfs_view');
    }
    
    //funcion para procesar el formulario
    function insertar_gtfs()
    {
        ...
        if($this->input->post('submit'))
        {
            ...
            else
            {
                ...
                $nueva_insercion = $this->gtfs_model->nuevo_gtfs($nombre,$email,$asunto,$mensaje,$fecha,$hora);
            }
        }
    }
}
 
/*fin del archivo gtfs*/